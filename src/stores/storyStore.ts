...
interface StoryStore {
  ...
  // Story operations
  createStory: (metadata: { title: string; description: string; author: string }) => Promise<string>
  loadStories: () => Promise<void>
  loadStory: (id: string) => Promise<void>
  updateStory: (partial: Partial<Story>) => Promise<void>
  deleteStory: (id: string) => Promise<void>

  // Artefact operations
  addArtefact: (artefact: Artefact) => Promise<void>
  updateArtefact: (id: string, partial: Partial<Artefact>) => Promise<void>
  deleteArtefact: (id: string) => Promise<void>

  // Utility
  getCurrentStory: () => Story | null
  getArtefactById: (id: string) => Artefact | null
}
